...
-Buffsoldier must gain Muscles to grow more strength.
-Buffsoldier can smoke to loose up power to gain MORE.
-This slasher suffers bad vision at the start of a round.]]
SlashCo.LangTable["Buffsoldier_tip"] = "-Avoid being hit by him."

SlashCo.LangTable["cigar"] = "cigar"
SlashCo.LangTable["muscles gained"] = "muscles gained"

SlashCo.LangTable["Buffsoldier_docDesc"] = [[A very massive human who comes from russia. Buffsoldier is well known for being russia's number one killer, and is now located on slashco grounds.]]
SlashCo.LangTable["Buffsoldier_docDescAdd"] = [[MGE will gain [MUSCLES] every hit they due to a survivor. The more [MUSCLES] he gains, the bigger the punches are.]]

--The Screamer
SlashCo.LangTable["Screamer"] = "The Screamer"
SlashCo.LangTable["Screamer_desc"] = [[The Friendly Slasher who seems to hide his true self.

-The Screamer can transform and gain high movement speed.
-Can reach his preys very easily.
-Its hard for him to get angry.]]
SlashCo.LangTable["Screamer_tip"] = "-Don't show mercy."

--TOPO.MP4
SlashCo.LangTable["Topomp4"] = "Topo.mp4"
SlashCo.LangTable["Topomp4_desc"] = [[I am also in the lost region, oh good heavens... and without being able to fly..

-Topo.mp4 can release a powerful scream.
-He can't attack unless he is chasing.
-This slasher has a bad perception.]]
SlashCo.LangTable["Topomp4_tip"] = "-Good Night."

-- HOTDOGMAN
SlashCo.LangTable["Hotdogman"] = "Hotdogman"
SlashCo.LangTable["Hotdogman_desc"] = [[I like hotdogs.

-Hotdogman can only leap during chase.
-He needs to find hotdogs.
-This slasher runs slow.]]
SlashCo.LangTable["Hotdogman_tip"] = "-Vomit a lot."
