...
SlashCo.LangTable["Covenant_docDesc"] = [[This Cryptid takes the form of the streamer known as Low Tier God. Carrying a golden cloak and the power of the dark side.]]
SlashCo.LangTable["Covenant_docDescAdd"] = [[This slasher moves slowly, but can transform its victims into members of his cult. Made up of two types of entities: Rocks and Cloaks. Rocks focuses on partial damage, while Cloaks will stop his victims by holding them to the ground.]]
...
SlashCo.LangTable["perk_not_owned"] = "Not Owned"
SlashCo.LangTable["perk_level_too_low"] = "Level too low"
SlashCo.LangTable["perk_conflict"] = "Conflicts with Active Perk"
